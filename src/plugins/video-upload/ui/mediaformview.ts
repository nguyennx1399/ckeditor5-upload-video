...
export default class MediaFormView extends View {
    ...
    public uploadButtonView: ButtonView;
    ...
    constructor(validators: Array<(v: MediaFormView) => string | undefined>, locale: Locale) {
        ...
        this.uploadButtonView = this._createButton(t('Upload'), iconUpload as any, 'ck-button-upload');
        // add event listener click to upload button
