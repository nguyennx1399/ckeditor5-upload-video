...
import { IconView, Template } from '@ckeditor/ckeditor5-ui';
import { type Locale, logWarning, toArray } from '@ckeditor/ckeditor5-utils';
...
class Media {
    ...
    private _getPlaceholderHtml(): string {
        ...
        icon.content = mediaPlaceholderIcon as any;
